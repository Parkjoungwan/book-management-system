...
| 이름 | GitHub | 역할 | 주요 기여 |
|------|--------|------|-----------|
| 박종완 | [@Parkjoungwan](https://github.com/Parkjoungwan) | 조장 · PM · 풀스택 | Spring Boot 백엔드 초기 구현, DTO 리팩토링, 서버사이드 검색(프론트+백), AI 표지 백엔드 프록시, 다중 삭제 버그 수정, gitignore 정리, 전체 PR 머지 관리, README·ERD·API 명세서 문서화 |
...
| 김영진 | [@OMG4325](https://github.com/OMG4325) | 프론트 · 백엔드 | CoverGenerator 초기 구현, 표지 이력 백엔드 구현(BookCover CRUD·소유권 검증·ExceptionHandler), UX 개선(userPrompt·CSS·입력 제한) |
